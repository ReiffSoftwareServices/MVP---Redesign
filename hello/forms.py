...
class AnmeldungForm(forms.ModelForm):
    ...
    extraInfo1 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo1').remote_field.model.objects.all(), empty_label="extraInfo1 auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Zusatzinfo", label="Zusatzinfo")
    extraInfo2 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo2').remote_field.model.objects.all(), empty_label="extraInfo2 auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Zusatzinfo", label="Zusatzinfo")
    extraInfo3 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo3').remote_field.model.objects.all(), empty_label="extraInfo3 auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Zusatzinfo", label="Zusatzinfo")
