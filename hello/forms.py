...
class AnmeldungForm(forms.ModelForm):
    ...
    extraInfo1 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo1').remote_field.model.objects.all(), empty_label="Bauteil auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Bauteil", label="Bauteil")
    extraInfo2 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo2').remote_field.model.objects.all(), empty_label="Koordinaten auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Koordinaten", label="Koordinaten")
    extraInfo3 = forms.ModelChoiceField(required=False, queryset=Scaffold._meta.get_field('extraInfo3').remote_field.model.objects.all(), empty_label="Innengerüst auswählen..", widget=forms.Select(attrs={'class':'form-control'}), help_text="Innengerüst", label="Innengerüst")
