...
class Area(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Bereich')
...
class Installation(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Anlage')
...
class Equipment(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Equipment')
...
class Level(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Ebene')
...
class Geoposition(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Örtlichkeit')
...
class CostPosition(models.Model):
    Name= models.CharField(primary_key= True, max_length = 50, verbose_name = 'Leistungsposition')
